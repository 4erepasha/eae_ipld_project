...
pg = st.navigation([
    ...
    st.Page("development/01_image_cropper.py", title="Image Cropper", icon="🖼️"),
    st.Page("development/02_netflix_data_analysis.py", title="Netflix Data Analysis", icon="🎬"),
    st.Page("development/03_temperatures_dashboard.py", title="Temperatures Dashboard", icon="🌦️"),
])
pg.run()